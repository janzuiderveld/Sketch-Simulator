...
parser.add_argument('--prompts', type=str, default="a painting in the style of Salvador Dali, trending on ArtStation:1.5 | a biomorphic sculpture in the style of Kandinsky, trending on artstation:1.5 | A woodblock print in the style of Ukiyo-e, trending on artstation:1.5 | a beautiful painting in the style of Sonia Delaunay, trending on artstation:1.5 | A print in the style of Art Deco, trending on artstation:1.5 | a beautiful painting in the style of Lyubov Popova, trending on artstation:1.5 | A print in the style of constructivism, trending on artstation | An epic print in the style of Syd Mead, trending on artstation" )
