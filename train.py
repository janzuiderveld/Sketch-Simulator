...
parser.add_argument('--init_cutn', type=int, default=64)
parser.add_argument('--num_init_cut_batches', type=int, default=8)
...
parser.add_argument('--embedding_avg', type=str, default="/content/Sketch-Simulator/results/sketchy_cutouts_vit-L_200.pt")
...
parser.add_argument('--output_dir', type=str, default="3D-selection_vit-L")
