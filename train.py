...
# parser.add_argument('--cutn', type=int, default=16 )
parser.add_argument('--cutn', type=int, default=24 )
...
parser.add_argument('--prompts', type=str, default=" a high quality print in the style of Lawren Harris, trending on artstation:1.5" )
# parser.add_argument('--prompts', type=str, default="")
...
parser.add_argument('--output_dir', type=str, default="lawren24")
