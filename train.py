...
parser.add_argument('--embedding_avg', type=str, default="/content/Sketch-Simulator/results/ovl_mean_sketchy1_cutouts.pt|/content/Sketch-Simulator/results/ovl_mean_sketchy3_cutouts.pt")
